...
<head>
    ...
    <title><?php echo e(config('True games', 'True games')); ?></title>
...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <?php echo e(config('True games', 'True games')); ?>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url("/howtofindus")); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url("/basket")); ?>">
  ...
  <div class="text-center text-dark p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2020 Copyright:
    <a class="text-dark" href="https://mdbootstrap.com/">TRUE GAMES</a>
  </div>
  <!-- Copyright -->
</footer>
</body>
</html>
<?php /**PATH /srv/users/praeuivg/dudzpez-m1/resources/views/layouts/app.blade.php ENDPATH**/ ?>